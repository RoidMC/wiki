...
当前协议仅适用于 [RoidMC](https://www.roidmc.com) 相关产品及网站使用，元梦UGC作品当前不在此协议列表影响范围内。

:::

:::info 注意事项

欢迎您访问我们的产品，RoidMC Studios（包括App及网站等产品提供的服务，以下简称“产品和服务”）是由 RoidMC Studios （以下简称“我们”）开发并运营的。 确保用户的数据安全和隐私保护是我们的首要任务， 本隐私政策载明了您访问和使用我们的产品和服务时所收集的数据及其处理方式。

:::

:::info 注意事项

请您在继续使用我们的产品前务必认真仔细阅读并确认充分理解本隐私政策全部规则和要点， 一旦您选择使用，即视为您同意本隐私政策的全部内容，同意我们按其收集和使用您的相关信息。 如您在在阅读过程中，对本政策有任何疑问，可联系我们的客服咨询， 请通过 <support@roidmc.com> 或产品中的反馈方式与我们取得联系。 如您不同意相关协议或其中的任何条款的，您应停止使用我们的产品和服务。
...
> ⚠️ **在以下情形中，共享、转让、公开披露您的个人信息无需事先征得您的授权同意：**
